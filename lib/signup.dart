...
class _SignupPageState extends State<SignupPage> {
  ...
  Color greenColor = Color(0xFFEF6C00);
              ...
              if (checkFields())
                {
                  ...
                  {
                    Toast.show("Signed Up Successfully", context, duration: Toast.LENGTH_LONG, gravity:  Toast.CENTER);
                    Navigator.of(context).pop();
                  }).catchError((e) {
                    Toast.show("Unable to sign up", context, duration: Toast.LENGTH_LONG, gravity:  Toast.CENTER);
